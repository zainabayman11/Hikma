...
const TwentiethOption = ({ navigation }) => {
  ...
  const PRiskoptions = [
    ...
    { id: 2, label: 'Known colonization with P. aeruginosa' },
    { id: 3, label: 'Prior infection with P. aeruginosa' },
    { id: 4, label: 'Antimicrobial therapy in the prior 3 months, particularly receipt of IV antibiotics during a hospitalization' },
    { id: 5, label: 'Recent hospitalization or stay in a long-term care facility' },
    { id: 6, label: 'Structural lung abnormalities (eg, bronchiectasis)' },
    { id: 7, label: 'Frequent chronic obstructive pulmonary disease exacerbations requiring frequent glucocorticoid or antibiotic use' },
    { id: 8, label: 'NONE of the Above' },
  ];


  const MRSARiskoptions = [
    { id: 1, label: 'Septic shock or need for mechanical ventilation' },
    { id: 2, label: 'Gram-positive cocci in clusters seen on sputum Gram stain' },
    { id: 3, label: 'Known colonization with MRSA' },
    { id: 4, label: 'Prior MRSA infection' },
    { id: 5, label: 'Necrotizing or cavitary pneumonia' },
    { id: 6, label: 'IV antibiotics during a hospitalization in the prior 3 months' },
    { id: 7, label: ' Recent influenza-like illness' },

    { id: 8, label: 'Necrotizing or cavitary pneumonia' },
    { id: 9, label: 'Empyema' },
    { id: 10, label: 'Risk factors for MRSA colonization: (End-stage renal disease, Living in crowded conditions, Incarceration, Injection drug use, Contact sports participation)' },

    { id: 11, label: 'NONE of the Above'  },
  ...
  const handleNextStep = () => {
    const pRiskSelected = pRiskOptions.length === 1 && pRiskOptions.includes(8); // Ensure only 'NONE of the Above' is selected in pRiskOptions
    const mrsaSelected = mrsaOptions.length === 1 && mrsaOptions.includes(11); // Ensure only 'NONE of the Above' is selected in mrsaOptions
  
    if (betaOption === 'NO' && pRiskSelected && mrsaSelected) {
      navigation.navigate('TwentyFirstOption');
    }
  }
...
export default TwentiethOption;
