...
const ThirteenthOption = ({ navigation }) => {
...
<View
          ...
          > {"Please clarify the following for optimum decision"}</Text>
          </View>
        <View />
...
<Text style={{
                  ...
                  {"Is the patient able to tolerate third-generation cephalosporins?"}
                  </Text>
            ...
            <Animatable.View
              ...
              style={{
                ...
                marginBottom: SIZES.margin,
                  ...
                  {
                    selectedOption === 'Yes' ?
                  'Combination therapy with a third-generation cephalosporin (eg, cefpodoxime) plus a macrolide (eg, azithromycin, clarithromycin)' :
...
{  SummaryModal  && 
      ...
      <Pressable
       ...
       <View style={styles.modalView}>
               ...
               <Text style={styles.modalText}>{
                 selectedOption === 'Yes' ? 'Comorbidities, smoking, or recent antibiotic use: Yes.\n\nPenicillin hypersensitivity or other intolerance: Yes.\n\nAble to use cephalosporins: Yes.\n\nReason to avoid macrolides: No.' :
                 "Comorbidities, smoking, or recent antibiotic use: Yes.\n\nPenicillin hypersensitivity or other intolerance: Yes.\n\nAble to use cephalosporins: No." }</Text>
 ...
 { DosesModal && 
  ...
  {selectedOption === 'Yes' ? (
    <>
    <Text style={[styles.modalText,{color:COLORS.primary}]}>{"Cefpodoxime"}
    <Text style={[styles.modalText,{color:'white'}]}>{" 200 mg orally twice daily for 5 day"}
 </Text>
    </Text>
...
<>
<Text style={[styles.modalText,{color:COLORS.primary}]}>{"Levofloxacin"}
    <Text style={[styles.modalText,{color:'white'}]}>{" 750 mg orally daily for 5 days"}
 </Text>
    </Text>
<Text style={[styles.modalText,{color:COLORS.primary,fontStyle:'italic',marginBottom:0}]}>{"OR"}</Text>

<Text style={[styles.modalText,{color:COLORS.primary}]}>{"Moxifloxacin"}
 <Text style={[styles.modalText,{color:'white'}]}>{" 400 mg orally daily for 5 days"}
</Text>
 </Text>
</>
...
export default ThirteenthOption;
