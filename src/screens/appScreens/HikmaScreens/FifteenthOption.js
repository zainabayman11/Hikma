            ...
            <Animatable.View
              ...
              style={{
                ...
                marginBottom: SIZES.margin,
                  ...
                  {'Amoxicillin-clavulanate Plus Doxycycline is an appropriate treatment option for this patient.'}
                  </Text>
   ...
   >
      <Pressable
       ...
       <View style={styles.modalView}>
               ...
               <Text style={styles.modalText}>{"Comorbidities, smoking, or recent antibiotic use: YES. \n\nPenicillin hypersensitivity or other intolerance: No.\n\nReason to avoid macrolides: YES"}</Text>
 ...
 { DosesModal && 
   ...
   >
      <Pressable
       ...
       <Text style={[styles.modalText,{color:COLORS.primary}]}>{"Amoxicillin- Clavulanate"}
    <Text style={[styles.modalText,{color:'white'}]}>{"  875 mg orally twice daily for 5 days ( Or extended-release 2000 mg orally twice daily for 5 days)"}
 </Text>
    </Text>
...
<Text style={[styles.modalText,{color:COLORS.primary}]}>{"Doxycycline"}
 <Text style={[styles.modalText,{color:'white'}]}>{" 100 mg orally twice daily for 5 days"}
</Text>
 </Text>
       </View>
     </Pressable>
